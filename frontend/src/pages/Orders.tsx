...
const Orders = ({ socket }: { socket: Socket }) => {
  ...
  useEffect(() => {
    setShowProductSuggestions((prev) => {
      const newLen = orderFormData.items.length;
      if (prev.length < newLen) {
        return [...prev, ...Array(newLen - prev.length).fill(false)];
      } else if (prev.length > newLen) {
  ...
  const toggleProductSuggestions = (index: number) => {
    const newShow = [...showProductSuggestions];
    ...
    <div className="min-h-screen" style={{ backgroundColor: colors.background }}>
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="p-3 rounded-2xl shadow-lg bg-gradient-to-br from-blue-500 to-blue-600">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-2">
            <div className="flex space-x-2">
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-3 rounded-xl transition-all duration-200 flex-1 justify-center ${
                  activeTab === 'customers' 
                    ? 'text-white shadow-lg bg-gradient-to-r from-purple-500 to-purple-600' 
                    : 'text-gray-600 hover:bg-gray-50'
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-3 rounded-xl transition-all duration-200 flex-1 justify-center ${
                  activeTab === 'orders' 
                    ? 'text-white shadow-lg bg-gradient-to-r from-pink-500 to-pink-600' 
                    : 'text-gray-600 hover:bg-gray-50'
                }`}
              >
                ...
                <form onSubmit={handleOrderSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-4">
                          ...
                          <div className="absolute z-10 w-full mt-2 bg-white border border-gray-200 rounded-xl shadow-2xl max-h-60 overflow-y-auto">
                            {filteredCustomers.map((customer) => (
                              <div
                                ...
                                className="p-4 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-0 transition-colors duration-150"
                              >
                      ...
                      <button
                        ...
                        className="flex items-center space-x-3 text-white px-6 py-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl w-full justify-center bg-gradient-to-r from-pink-500 to-pink-600"
                      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                      <button
                        ...
                        className="flex items-center space-x-3 w-full text-white px-6 py-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl justify-center bg-gradient-to-r from-purple-500 to-purple-600"
                      >
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        type="button"
                        onClick={addItem}
                        className="flex items-center space-x-2 text-white px-4 py-3 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl bg-gradient-to-r from-green-500 to-green-600"
                      >
                        <Plus className="h-4 w-4" />
                    ...
                    {orderFormData.items.map((item, index) => {
                      ...
                      return (
                        <div key={index} className="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:border-gray-300 transition-all duration-200">
                          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
                            <div className="lg:col-span-5 relative">
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  className={`w-full p-3 border border-gray-300 rounded-xl pr-10 ${inputFocusStyle}`}
                                  placeholder="Search or enter product name"
                                />
                                <button
                                  type="button"
                                  onClick={() => toggleProductSuggestions(index)}
                                  className="absolute right-3 top-3 text-gray-400 hover:text-gray-600 transition-colors"
                                >
                                  {showProductSuggestions[index] ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
                                </button>
                              </div>
                              
                              {item.productName.length > 0 && filteredProducts.length > 0 && showProductSuggestions[index] && (
                                <div className="absolute z-10 w-full mt-2 bg-white border border-gray-200 rounded-xl shadow-2xl max-h-60 overflow-y-auto">
                                  {filteredProducts.map((product) => (
                                    <div
                                      key={product._id}
                                      onClick={() => handleProductSelect(index, product)}
                                      className="p-3 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-0 transition-colors duration-150 flex justify-between items-center"
                                    >
                                      <div>
                                      ...
                                      <div className="text-right">
                                        <div className="font-semibold text-green-600">LKR {product.unitPrice}</div>
                                        <div className="text-xs text-gray-500">Stock: {product.quantity || 'N/A'}</div>
                                      </div>
                                    </div>
                                  ))}
                                </div>
                            ...
                            <div className="lg:col-span-1">
                              <button
                                ...
                                className="w-full flex items-center justify-center space-x-2 bg-red-500 text-white p-3 rounded-xl hover:bg-red-600 transition-all duration-200 shadow-lg hover:shadow-xl"
                              >
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-8 border border-gray-200">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                      ...
                      <div className="text-center p-4 rounded-xl border shadow-lg bg-gradient-to-r from-blue-500 to-blue-600 border-blue-600">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <button
                        ...
                        className="flex items-center space-x-3 text-white px-8 py-4 rounded-xl transition-all duration-200 shadow-2xl hover:shadow-3xl transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:shadow-2xl bg-gradient-to-r from-green-500 to-green-600"
                      >
                ...
                {loading.customers ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 text-white px-6 py-3 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl mx-auto bg-gradient-to-r from-pink-500 to-pink-600"
                    >
                      <Plus className="h-4 w-4" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {customers
                      ...
                      .map((customer) => (
                      <div key={customer._id} className="bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-200 overflow-hidden group">
                        <div className="p-6">
                          ...
                          <div className="flex items-center space-x-2 pt-4 border-t border-gray-100">
                            <button
                              ...
                              className="flex items-center space-x-1 bg-blue-500 text-white px-3 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 text-sm flex-1 justify-center"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center space-x-1 bg-purple-500 text-white px-3 py-2 rounded-lg hover:bg-purple-600 transition-colors duration-200 text-sm"
                            >
                              <Edit className="h-3 w-3" />
                            </button>
                            <button
                              onClick={() => handleDeleteCustomer(customer._id)}
                              className="flex items-center space-x-1 bg-red-500 text-white px-3 py-2 rounded-lg hover:bg-red-600 transition-colors duration-200 text-sm"
                            >
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold mt-1 text-blue-600">{orderStats.total}</p>
                  </div>
                ...
                {loading.orders ? (
                  ...
                  <div className="space-y-4">
                    {(showHiddenOrders ? orders : regularOrders).map((order) => (
                      <div key={order._id} className={`rounded-xl border transition-all duration-200 overflow-hidden ${
                        order.personalized 
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-4 lg:space-y-0">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                              <button
                                ...
                                className="flex items-center space-x-2 bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors duration-200 text-sm"
                              >
                                <Download className="h-3 w-3" />
                                <span>Invoice</span>
                              </button>
                              <button
                                ...
                                disabled={!order.customer}
                                className="flex items-center space-x-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors duration-200 text-sm"
                              >
        ...
        {showCustomerModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full transform animate-scale-in">
              <div className="p-6 rounded-t-2xl text-white bg-gradient-to-r from-blue-500 to-blue-600">
              ...
              <form onSubmit={handleCustomerSubmit} className="p-6 space-y-6">
                ...
                <div className="flex space-x-4 pt-4">
                  <button
                    ...
                    className="flex-1 bg-gray-500 text-white py-4 rounded-xl hover:bg-gray-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex-1 text-white py-4 rounded-xl transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 bg-gradient-to-r from-green-500 to-green-600"
                  >
              ...
              <div className="p-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <button
                    ...
                    className={`flex-1 text-white py-4 rounded-xl transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 ${getConfirmButtonColor()}`}
                  >
                    Confirm
                  </button>
                </div>
